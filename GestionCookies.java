 ...
 */
@WebServlet(urlPatterns = {"/GestionCookies"})
public class GestionCookies extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (mesCookies == null) {
            ...
            msg = "Un cookie vinet d'étre créé, priére de rafrichir la page.";
        }
        else {
            contenuCookie = mesCookies[0].getValue();
            msg = "Vous avez un cookie qui contient le texte suivant : " + "<strong>" + contenuCookie + "</strong>";
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GestionCookies</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println(msg);
            out.println("</body>");
